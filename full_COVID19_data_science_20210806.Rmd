...
- The incubation period is [2-14 days](https://www.cdc.gov/coronavirus/2019-ncov/symptoms-testing/symptoms.html){target="_blank"}, so observed data lags community transmission 1-2 weeks
...
- As of [today](https://www.nytimes.com/interactive/2021/us/florida-covid-cases.html){target="_blank"}, Florida has had 2.7 million COVID-19 cases (1 million in SFL) and 39965 deaths (`r format(eval(6472 + 3079 + 2883), scientific = FALSE)` in SFL) since March 5, 2020
...
![https://slate.com/technology/2020/06/covid-death-rate-declining-explained.html](figures/COVID_deaths_headline_20200616.png){target="_blank"}
...
- Based on the medical experience at the time, we expected [80% of ventilated patients to expire](https://pubmed.ncbi.nlm.nih.gov/33119402/){target="_blank"}
...
- The local offices of the health department informed us that that medical examiners offices were hopelessly backlogged (Florida required at that time for all COVID-19 deaths to be certified by a medical examiner; [this policy changed in August](https://www.tampabay.com/news/health/2020/08/26/medical-examiners-no-longer-required-to-certify-covid-19-deaths-in-florida/){target="_blank"})


## Making Inference

- We no longer have 2-3 month delays in death reporting; this "lag" is 1-3 weeks now, and we have [a better understanding](https://covidtracking.com/analysis-updates/how-lagging-death-counts-muddied-our-view-of-the-pandemic){target="_blank"} of the implications of this delay 
- However, even in 2021, these same shoddy and misinterpreted data are still being used to erroneously claim that the Delta variant ["isn't that bad"](https://twitter.com/NateSilver538/status/1423243926421614595){target="_blank"}
...
- Our paper is [here](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC7994185){target="_blank"} (it's open access)
- The emergency order giving us access to the data expired in June 2021, so we have not had access to state data
- We have access to similar data [from the CDC](https://healthdata.gov/Health/COVID-19-Community-Profile-Report/gqxm-d9w9){target="_blank"}, but they use a different data dictionary
...
GitHub repository for this presentation: [https://github.com/gabrielodom/JSM_2021_COVID_Visuals](https://github.com/gabrielodom/JSM_2021_COVID_Visuals){target="_blank"}
